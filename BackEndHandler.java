/**
 *	File Name  = BackEndHandler.java	Version 2.0.0
 *	Class Name = BackEndHandler
 *	
 *	Copyright (c) 2012 - Mohammad Mujeeb	
 *	
...
public class BackEndHandler extends Thread
{
	...
	public BackEndHandler(WindowAdapter client, short operation)
	{
		...
		MyFileFilter filter3= new MyFileFilter(new String[]{"mpg", "wmv", "dat"}, "Video files");
