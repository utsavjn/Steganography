/**
 *	File Name  = PreRetrieveGUI.java	Version 2.0.0
 *	Class Name = PreRetrieveGUI
 *	
...
class MessageDisplay extends JFrame
{
	...
	{
		super("Retrieved message from file '"+ fileName+ "' - Steganograph "+ Steganograph.VERSION+ "    -- By: Rajat Raghuwanshi & Utsav Jain");
		setDefaultCloseOperation(DISPOSE_ON_CLOSE);
