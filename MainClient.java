/**  
 *  File Name  = MainClient.java    Version 2.0.0  
 *  Class Name = MainClient  
 *    
...
{   
    ...
    private MainClient()   
    {   
        mainFrame= new JFrame("Steganograph "+ Steganograph.VERSION+ "    --  By: Utsav Jain & Rajat Raghuwanshi");   
        ...
        lblName= new MyJLabel("By:-   Utsav Jain & Rajat Raghuwanshi", myFont, Color.blue, Color.white);   
        lblEmail= new MyJLabel("Under The Guidance by RAJU SHARMA", arialFont, myColor, Color.white);   
        lblPhone= new JLabel(" ");   
