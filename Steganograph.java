/**
 *	File Name  = Steganograph.java	Version 2.0.0
 *	Class Name = Steganograph
 *	
 *	Copyright (c) 2005 - Utsav Jain 
 *	
 *  @author Utsav Jain
...
public class Steganograph
{
	...
	private static class AboutFrame extends JFrame implements ActionListener
	{
		...
		public AboutFrame()
		{
			...
			lblName= new MyJLabel("By:   Rajat Raghuwanshi & Utsav Jain", new Font("Monotype Corsiva", Font.PLAIN, 14), GREEN, BLACK);
			lblEmail= new MyJLabel("      Under The guidence by RAJU SHARMA", GREEN, BLACK);
		...
		public void actionPerformed(ActionEvent e)
		{
			if(e.getSource()== btnVisit)
				new HTMLFrame("http://facebook.com/utsav.jn", true);
			...
			if(e.getSource()== btnComments)
				new HTMLFrame("http://javapoint.in/comments.html", true);
...
class HTMLFrame extends JFrame implements HyperlinkListener
{
	...
	{
		super("Help - Steganograph "+ Steganograph.VERSION+ " -- By: Rajat Raghuvanshi & Utsav Jain ");
		...
		if(isOnline)
		{
			...
			setTitle("Steganograph "+ Steganograph.VERSION+ " -- By: Rajat Raghuvanshi & Utsav Jain");
		}
		//else
