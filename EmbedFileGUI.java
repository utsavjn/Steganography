/**
 *	File Name  = EmbedFileGUI.java	Version 2.0.0
 *	Class Name = EmbedFileGUI
 *	
 *	Copyright (c) 2012 - Utsav Jain	
 *	
 *  @author Utsav Jain
 *  @date Saturday, March 12, 2012
 */
...
public class EmbedFileGUI extends JFrame implements ActionListener, ItemListener
{
	...
	{
		super("Embedding file - Steganograph "+ Steganograph.VERSION+ "   -- By:Rajat Raghuvanshi & Utsav Jain");
		...
		lblPassword= new MyJLabel("Password (Minimum 8 chars)", arialFont, Color.black, Color.lightGray);
		...
		panelFeatures2= UtilityOperations.createBorderedPanel(panelFeatures2, "Encryption", 3, 3);
